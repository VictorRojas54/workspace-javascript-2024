...
function changeStyle(e){
    e.preventDefault(); // prevent the checkbox being clicked --- otherwise get two clicks
    ...
    this.animate([{transform:'rotate(0deg)'},{transform: 'rotate(180deg)'}],{duration:500,fill:'forwards'});
}
